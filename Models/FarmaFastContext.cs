...
public partial class FarmaFastContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Marca>(entity =>
        {
            ...
            entity.HasOne(d => d.IdestiloNavigation).WithMany(p => p.Marcas)
                .HasForeignKey(d => d.Idestilo)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__marca__idestilo__5AEE82B9");

            entity.HasOne(d => d.IdproveedorNavigation).WithMany(p => p.Marcas)
                .HasForeignKey(d => d.Idproveedor)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__marca__idproveed__75A278F5");

            entity.HasOne(d => d.IdvigenciaNavigation).WithMany(p => p.Marcas)
